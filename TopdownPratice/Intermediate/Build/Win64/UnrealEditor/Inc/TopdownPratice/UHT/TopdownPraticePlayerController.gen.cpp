...
struct Z_CompiledInDeferFile_FID_Users_owner_Desktop_ProjectForUE_UEPratice_TopdownPratice_Source_TopdownPratice_TopdownPraticePlayerController_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_ATopdownPraticePlayerController, ATopdownPraticePlayerController::StaticClass, TEXT("ATopdownPraticePlayerController"), &Z_Registration_Info_UClass_ATopdownPraticePlayerController, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(ATopdownPraticePlayerController), 3481656391U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_owner_Desktop_ProjectForUE_UEPratice_TopdownPratice_Source_TopdownPratice_TopdownPraticePlayerController_h_818077575(TEXT("/Script/TopdownPratice"),
