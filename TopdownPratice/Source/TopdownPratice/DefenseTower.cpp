...
ADefenseTower::ADefenseTower()
{
	...
	static ConstructorHelpers::FObjectFinder<UBlueprint> blueprint_finder(TEXT("Blueprint'/Game/TopDown/Blueprints/BP_Fireball'"));
...
{
	ATopDownNewCharacter* player = Cast<ATopDownNewCharacter>(OtherActor);
...
void ADefenseTower::OnMeshBeginOverlap(AActor* OtherActor)
{
	...
	/*ATopDownNewCharacter* character = weapon->Holder;
	if (character->IsA(ATopDownNewCharacter::StaticClass()) &&
