...
#include "UEPRATICE/PangaeaGameInstance.h"
PRAGMA_DISABLE_DEPRECATION_WARNINGS
void EmptyLinkFunctionForGeneratedCodePangaeaGameInstance() {}

// Begin Cross Module References
ENGINE_API UClass* Z_Construct_UClass_UGameInstance();
UEPRATICE_API UClass* Z_Construct_UClass_UPangaeaGameInstance();
UEPRATICE_API UClass* Z_Construct_UClass_UPangaeaGameInstance_NoRegister();
...
template<> UEPRATICE_API UClass* StaticClass<UPangaeaGameInstance>()
{
	return UPangaeaGameInstance::StaticClass();
}
...
// Begin Registration
struct Z_CompiledInDeferFile_FID_Users_owner_Desktop_ProjectForUE_UEPratice_UEPRATICE_Source_UEPRATICE_PangaeaGameInstance_h_Statics
{
	static constexpr FClassRegisterCompiledInInfo ClassInfo[] = {
		{ Z_Construct_UClass_UPangaeaGameInstance, UPangaeaGameInstance::StaticClass, TEXT("UPangaeaGameInstance"), &Z_Registration_Info_UClass_UPangaeaGameInstance, CONSTRUCT_RELOAD_VERSION_INFO(FClassReloadVersionInfo, sizeof(UPangaeaGameInstance), 3609499706U) },
	};
};
static FRegisterCompiledInInfo Z_CompiledInDeferFile_FID_Users_owner_Desktop_ProjectForUE_UEPratice_UEPRATICE_Source_UEPRATICE_PangaeaGameInstance_h_252353586(TEXT("/Script/UEPRATICE"),
	Z_CompiledInDeferFile_FID_Users_owner_Desktop_ProjectForUE_UEPratice_UEPRATICE_Source_UEPRATICE_PangaeaGameInstance_h_Statics::ClassInfo, UE_ARRAY_COUNT(Z_CompiledInDeferFile_FID_Users_owner_Desktop_ProjectForUE_UEPratice_UEPRATICE_Source_UEPRATICE_PangaeaGameInstance_h_Statics::ClassInfo),
	nullptr, 0,
	nullptr, 0);
// End Registration
